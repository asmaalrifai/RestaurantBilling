...
void generateBillHeader(struct Order *order)
{
    printf("\n\n");
    printf("\t\tASOOM Restaurant");
    printf("\n\t\t----------------");
    printf("\nInvoice Number: %d", order->invoiceNumber);
    printf("\nDate: %s", order->date);
    printf("\nInvoice To: %s", order->customerInfo.name);
    printf("\nPhone: %s", order->customerInfo.phone);
    printf("\n--------------------------------------\n");
    printf("Items\t\t");
    printf("Qty\t\t");
    printf("Total\t\t");
